...
enum opt_code
{
  ...
  OPT_malways_memw = 1192,                   /* -malways-memw */
  OPT_mauto_litpools = 1193,                 /* -mauto-litpools */
  OPT_mconst16 = 1194,                       /* -mconst16 */
  OPT_mfix_esp32_psram_cache_issue = 1195,   /* -mfix-esp32-psram-cache-issue */
  OPT_mfix_esp32_psram_cache_strategy_ = 1196,/* -mfix-esp32-psram-cache-strategy= */
  OPT_mforce_no_pic = 1197,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1198, */              /* -mfused-madd */
  OPT_mlongcalls = 1199,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1200,            /* -mserialize-volatile */
  OPT_mtarget_align = 1201,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1202,         /* -mtext-section-literals */
  OPT_n = 1203,                              /* -n */
